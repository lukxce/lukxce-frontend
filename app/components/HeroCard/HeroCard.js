...
export default function HeroCard({
  ...
  description =
    "Paid, growth, positioning, and the numbers behind all of it.",
  socialProofLabel = "Employee #6 to €40M ARR once. Currently doing it again as Head of Marketing at Hypefy.",
  progressActiveCount = 0,
  avatarSrc = DEFAULT_AVATAR,
  avatarAlt = "Luka Jovanović",
  availabilitySlotsLabel = "",
  availabilityPeriodLabel = "",
  location = "Belgrade, working across Europe",
  templateHref = "#",
  templateLabel = "Praxis template →",
  primaryCtaHref = "/#work",
  primaryCtaLabel = "See the work",
  secondaryCtaHref = "/journal",
  secondaryCtaLabel = "Journal",
  socialLinks,
  className = "",
}) {
  return (
